...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<User>().HasData(
            new User { Id = 1, FullName = "Admin", Email = "Admin@Admin.com", IsAdmin = false, PasswordHash = "AQAAAAIAAYagAAAAEORnOyHZWpGTFS206rXM8pdrBz/Y6pJVOVO8gnGRg6hlLw0VLtacH0ZIGx5Rk9/a0A==", PhoneNumber = "999", ChatId = 5505222952, IsFollowUpAdmin = true, IsItAdmin = false }
            );
